...
const themeBySlug: Record<string, "zhihu" | "global" | "tech" | "ccd" | "visual" | "workflow"> = {
    ...
    <div className={`studio-project-art studio-art-${theme} ${className}`} aria-hidden="true">
      ...
      {theme === "zhihu" ? (
        <>
          ...
          <div className="studio-question studio-question-back">让一个好问题，<br />遇见有趣的回答。</div>
          <div className="studio-question studio-question-front">
            <span className="font-pixel">LET&apos;S TALK</span>
            <strong>内容的下一站，<br />是人与人的连接。</strong>
      ...
      {theme === "global" ? (
        <>
          <div className="studio-art-globe"><span /><span /><span /></div>
          <div className="studio-global-routes"><span className="studio-global-route" /><span className="studio-global-route" /><span className="studio-global-route" /></div>
          <span className="studio-global-word">Hello,<br /><em>world.</em></span>
          <span className="studio-global-stamp">成都<br />→ 世界</span>
        </>
      ) : null}
      ...
      {theme === "tech" ? (
        <>
          ...
          <div className="studio-tech-terminal">
            ...
            <span className="studio-tech-line" /><span className="studio-tech-line" /><span className="studio-tech-line" />
            <span className="studio-tech-cursor" />
          </div>
          <div className="studio-tech-stack"><span className="studio-tech-chip">AI</span><span className="studio-tech-chip">ROBOT</span><span className="studio-tech-chip">CHIP</span></div>
        </>
      ) : null}
      ...
      {theme === "ccd" ? (
        <>
          ...
          <div className="studio-ccd-metric"><strong>20W+</strong><span>CUMULATIVE GMV</span></div>
          <div className="studio-ccd-tags"><span>SOLD</span><span>RENTED</span><span>50%+</span></div>
          <span className="studio-art-focus studio-art-focus-one" /><span className="studio-art-focus studio-art-focus-two" />
        </>
      ) : null}
