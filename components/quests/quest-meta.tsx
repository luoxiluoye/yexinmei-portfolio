...
export function QuestMeta({ quest }: { quest: Quest }) {
  return (
    <div id="quick-look" className="scroll-mt-24">
      <PixelPanel eyebrow="01" title="项目概览">
        <dl className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          <Meta label="我的角色" value={quest.role} />
          <Meta label="时间" value={quest.period} />
          <Meta label="平台与场景" value={quest.platform} />
          <Meta label="项目方向" value={quest.categories.slice(0, 2).join(" / ")} />
        </dl>
