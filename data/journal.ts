export const journalSeed = [
  ...
  },
  {
    ...
    body: [
      "我本科是广播电视编导，影像一直是我长期使用的表达方式。比起单纯追求画面好看，我更在意一张照片或者一个镜头到底留下了什么。",
  ...
  },
  {
    ...
    body: [
      ...
      "比如选题时，我希望机器先帮我把候选信息归拢、去重、标记时间和来源，但最后要不要做、从哪个角度做，仍然需要我自己判断。发布和复盘也是一样，自动化应该让流程更顺，同时保留内容判断。",
      "所以我现在更愿意把 AI 当作一个工作台组件，辅助处理重复的信息工作。省下来的时间，应该重新花在那些更难被自动化的部分：用户感受、取舍、结构和表达。",
    ],
  },
] as const;
