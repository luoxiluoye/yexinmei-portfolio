    ...
    <main className="site-container py-5 lg:py-8">
      ...
      <section className="mt-5 grid gap-4 pb-8 lg:mt-8 lg:grid-cols-[75fr_25fr] lg:gap-5 lg:pb-0">
        <div className="min-w-0">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {journalSeed.map((entry) => (
              <article
                key={entry.title}
                className="rpg-note-card group grid grid-cols-[80px_1fr] gap-4 border-2 border-border bg-paper p-3 sm:block sm:min-h-[236px] sm:p-4"
              >
        ...
        <aside className="hidden lg:block">
          <PixelPanel eyebrow="DIGITAL" title="GARDEN SUMMARY" interactive contentClassName="p-3">
